...
##Metrics
Typical metric path: **Application Infrastructure Performance|\<Tier\>|Custom Metrics|Amazon EC2|\<Account Name\>|Instance|\<instance id or name\>** followed by the metrics defined in the link below:
